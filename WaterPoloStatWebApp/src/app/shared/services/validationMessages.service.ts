...
export class ValidationMessagesService {
  ...
  getErrorMessage(formControl: AbstractControl | FormControl | null, compareFieldName?: string): string {
  ...
  static getValidatorErrorMessage(validatorName: string, validatorValue?: any, compareFieldName?: string):string {
